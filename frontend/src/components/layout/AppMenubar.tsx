...
export function AppMenubar({
  ...
  return (
    <Menubar className="rounded-none border-b border-border border-t-0 border-x-0 py-0 px-2 h-9 bg-sidebar shrink-0" style={{ '--wails-draggable': 'drag' } as React.CSSProperties}>
      {/* File */}
      <MenubarMenu>
