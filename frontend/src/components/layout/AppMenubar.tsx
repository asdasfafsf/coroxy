...
export function AppMenubar({
  ...
  return (
    <Menubar className="rounded-none border-b border-border border-t-0 border-x-0 pl-[78px] pr-2 h-9 bg-card" style={{ '--wails-draggable': 'drag' } as React.CSSProperties}>
      {/* File */}
      <MenubarMenu>
